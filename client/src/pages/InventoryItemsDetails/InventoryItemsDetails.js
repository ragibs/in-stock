...
function InventoryItemsDetails() {
    ...
    return <div className="page-body">
        <header className="inventory-header">
            <h1 className="inventory-header__itemName"><Link to={`/warehouses/${currentItem.warehouseID}`}><img src={backArrow} className="backArrow" alt="back" /></Link>{currentItem.itemName}</h1>
